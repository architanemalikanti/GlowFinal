...
struct LoginView: View {
    @EnvironmentObject var authManager: AuthManager  // Changed from @StateObject to @EnvironmentObject
            ...
            ScrollView {
                VStack(spacing: 30) {
                    ...
                    VStack(spacing: 20) {
                        ...
                        // Main Action Button
                        Button(action: {
                            print("Button tapped - isLogin: \(isLogin)")
                            Task {
                                if isLogin {
                                ...
                                print("After auth attempt - isAuthenticated: \(authManager.isAuthenticated)")
                            }
                        }) {
                            HStack {
